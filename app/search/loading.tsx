  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      <section className="mx-auto max-w-7xl px-6 py-16">
        ...
        <div className="mt-4 h-10 w-72 animate-pulse rounded bg-surface-elevated" />
        <div className="mt-4 h-5 w-96 max-w-full animate-pulse rounded bg-surface-elevated" />

        <div className="mt-8 flex max-w-3xl gap-3">
          <div className="h-[60px] flex-1 animate-pulse rounded-xl bg-surface" />
          <div className="h-[60px] w-28 animate-pulse rounded-xl bg-surface-elevated" />
        </div>

        <section className="mt-12">
          <div className="mb-6">
            <div className="h-8 w-64 animate-pulse rounded bg-surface-elevated" />
            <div className="mt-3 h-4 w-40 animate-pulse rounded bg-surface-elevated" />
          </div>
