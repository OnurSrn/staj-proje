      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-10 md:grid-cols-[280px_1fr]">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-4 h-10 w-72 max-w-full animate-pulse rounded bg-neutral-800" />

            <div className="mt-6 flex flex-wrap gap-3">
              <div className="h-7 w-24 animate-pulse rounded-full bg-neutral-800" />
              <div className="h-7 w-32 animate-pulse rounded-full bg-neutral-800" />
              <div className="h-7 w-40 animate-pulse rounded-full bg-neutral-800" />
            </div>
              ...
              >
                ...
                <div className="p-3">
                  ...
                  <div className="mt-3 flex justify-between">
                    ...
                    <div className="h-5 w-8 animate-pulse rounded bg-neutral-800" />
                  </div>
                </div>
              </div>
            ))}
